# DevOps Engineer L1 – 90-Day Interview Preparation

_Owner:_ paulboby1  
_Daily:_ 30 min sharp | _Weekly:_ Mini projects  
_Status:_ Week 1 Completed – 12 Nov 2025

## Weekly Roadmap

- **Week 1: Linux & Bash** ✅ COMPLETED
  - Day 1: System basics & monitoring
  - Day 2: Users, permissions, processes
  - Day 3: Networking & troubleshooting
...
- Week 7: Ansible (Configuration Management)
- Week 8: Prometheus + Grafana (Monitoring Stack)
- Week 9–12: Full CI/CD, Security, Mock Interviews

## Progress

![Day 7/90](https://progress-bar.dev/7/?title=Week_1_Complete&width=400&color=00aa00)

## Skills Coverage

This preparation covers essential **DevOps Engineer** skills:

### Technical Skills

- ✅ **Good Scripting Skills**: Bash automation (Week 1)
- 🔄 **Cloud Platforms**: AWS/GCP (Weeks 3-8)
- 🔄 **Container Orchestration**: Docker, Kubernetes (Weeks 3-4)
- 🔄 **Programming**: Python/Golang projects (Integrated throughout)
- 🔄 **CI/CD**: GitHub Actions, Jenkins, Bitbucket Pipelines (Weeks 2, 5)
- 🔄 **IaC**: Terraform, CloudFormation, Crossplane (Week 6)
- 🔄 **Monitoring**: Prometheus, Grafana, Datadog, NewRelic (Week 8)
- 🔄 **Configuration Management**: Ansible, Chef, Puppet (Week 7)
- ✅ **Security & Networking**: Fundamentals covered (Week 1)
- ✅ **DBMS**: Basic knowledge (Integrated)
